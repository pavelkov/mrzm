...
${OBJECTDIR}/ScheduledTask.o: ScheduledTask.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/ScheduledTask.o ScheduledTask.cpp
...
${OBJECTDIR}/ScheduledTask_nomain.o: ${OBJECTDIR}/ScheduledTask.o ScheduledTask.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/ScheduledTask_nomain.o ScheduledTask.cpp;\
	else  \
...
${OBJECTDIR}/engine_nomain.o: ${OBJECTDIR}/engine.o engine.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/engine_nomain.o engine.cpp;\
	else  \
